...
export const validateDelegationTag = (() => { const __is = (input: any): input is DelegationTag => Array.isArray(input) && (input.length === 4 && "delegation" === input[0] && "string" === typeof input[1] && "string" === typeof input[2] && "string" === typeof input[3]); let errors: any; let $report: any; return (input: any): typia.IValidation<DelegationTag> => {
    if (false === __is(input)) {
        errors = [];
