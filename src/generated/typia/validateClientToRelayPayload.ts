...
export const validateClientToRelayPayload = (() => { const $join = (typia.createValidate as any).join; const $ip0 = (input: any) => {
    const array = input;
    ...
    const tuplePredicators = [
        ...
        [
            (top: any[]): any => [
                "REQ" === top[0],
                "string" === typeof top[1]
            ].every((flag: boolean) => flag) && (Array.isArray(top.slice(2)) && top.slice(2).map((elem: any, _index19: number) => "object" === typeof elem && null !== elem && false === Array.isArray(elem) && $vo1(elem, _path + "[" + (2 + _index19) + "]", false && _exceptionable)).every((flag: boolean) => flag)),
            (entire: any[]): any => [
            ...
            })) && entire.slice(2).map((elem: any, _index20: number) => ("object" === typeof elem && null !== elem && false === Array.isArray(elem) || $report(_exceptionable, {
                path: _path + "[" + (2 + _index20) + "]",
                expected: "Partial<__type>",
                value: elem
            })) && $vo1(elem, _path + "[" + (2 + _index20) + "]", true && _exceptionable) || $report(_exceptionable, {
                path: _path + "[" + (2 + _index20) + "]",
                expected: "Partial<__type>",
                value: elem
        ...
        [
            (top: any[]): any => [
                "COUNT" === top[0],
                "string" === typeof top[1]
            ].every((flag: boolean) => flag) && (Array.isArray(top.slice(2)) && top.slice(2).map((elem: any, _index21: number) => "object" === typeof elem && null !== elem && false === Array.isArray(elem) && $vo1(elem, _path + "[" + (2 + _index21) + "]", false && _exceptionable)).every((flag: boolean) => flag)),
            (entire: any[]): any => [
                ...
                expected: "...Partial<__type>",
                value: entire.slice(2)
            })) && entire.slice(2).map((elem: any, _index22: number) => ("object" === typeof elem && null !== elem && false === Array.isArray(elem) || $report(_exceptionable, {
                path: _path + "[" + (2 + _index22) + "]",
                expected: "Partial<__type>",
                value: elem
            })) && $vo1(elem, _path + "[" + (2 + _index22) + "]", true && _exceptionable) || $report(_exceptionable, {
                path: _path + "[" + (2 + _index22) + "]",
                expected: "Partial<__type>",
                value: elem
            })).every((flag: boolean) => flag) || $report(_exceptionable, {
...
}; const $io0 = (input: any): boolean => "string" === typeof input.id && RegExp("^[0-9a-f]{64}$").test(input.id) && ("string" === typeof input.pubkey && RegExp("^[0-9a-f]{64}$").test(input.pubkey)) && "number" === typeof input.created_at && ("number" === typeof input.kind && (0 <= input.kind && input.kind <= 65535)) && (Array.isArray(input.tags) && input.tags.every((elem: any) => Array.isArray(elem) && ("string" === typeof elem[0] && (Array.isArray(elem.slice(1)) && elem.slice(1).every((elem: any) => "string" === typeof elem))))) && "string" === typeof input.content && ("string" === typeof input.sig && RegExp("^[0-9a-f]{128}$").test(input.sig)); const $io1 = (input: any): boolean => (undefined === input.ids || Array.isArray(input.ids) && input.ids.every((elem: any) => "string" === typeof elem)) && (undefined === input.authors || Array.isArray(input.authors) && input.authors.every((elem: any) => "string" === typeof elem)) && (undefined === input.kinds || Array.isArray(input.kinds) && input.kinds.every((elem: any) => "number" === typeof elem)) && (undefined === input.since || "number" === typeof input.since) && (undefined === input.until || "number" === typeof input.until) && (undefined === input.limit || "number" === typeof input.limit) && (undefined === input.search || "string" === typeof input.search) && Object.keys(input).every((key: any) => {
    ...
    return true;
        ...
        value: input.tags
    })) && input.tags.map((elem: any, _index23: number) => (Array.isArray(elem) || $report(_exceptionable, {
        ...
        expected: "...string",
        value: elem.slice(1)
    })) && elem.slice(1).map((elem: any, _index24: number) => "string" === typeof elem || $report(_exceptionable, {
        ...
        expected: "(string & Pattern<\"^[0-9a-f]{128}$\">)",
        value: input.sig
    })].every((flag: boolean) => flag); const $vo1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [undefined === input.ids || (Array.isArray(input.ids) || $report(_exceptionable, {
        path: _path + ".ids",
        expected: "(Array<string> | undefined)",
        value: input.ids
    })) && input.ids.map((elem: any, _index25: number) => "string" === typeof elem || $report(_exceptionable, {
        ...
        expected: "(Array<string> | undefined)",
        value: input.authors
    })) && input.authors.map((elem: any, _index26: number) => "string" === typeof elem || $report(_exceptionable, {
        ...
        value: input.kinds
    })) && input.kinds.map((elem: any, _index27: number) => "number" === typeof elem || $report(_exceptionable, {
        ...
        if ("string" === typeof key && RegExp(/^#(.*)/).test(key))
            return undefined === value || (Array.isArray(value) || $report(_exceptionable, {
                ...
                expected: "(Array<string> | undefined)",
                value: value
            })) && value.map((elem: any, _index28: number) => "string" === typeof elem || $report(_exceptionable, {
                path: _path + $join(key) + "[" + _index28 + "]",
                expected: "string",
                value: elem
            })).every((flag: boolean) => flag) || $report(_exceptionable, {
                path: _path + $join(key),
        ...
        return true;
    }).every((flag: boolean) => flag)].every((flag: boolean) => flag); const __is = (input: any): input is ClientToRelayPayload => Array.isArray(input) && ($ip0(input) || false); let errors: any; let $report: any; return (input: any): typia.IValidation<ClientToRelayPayload> => {
    if (false === __is(input)) {
        errors = [];
        ...
        ((input: any, _path: string, _exceptionable: boolean = true) => (Array.isArray(input) || $report(true, {
            ...
            value: input
        })) && ($vp1(input, _path + "", true && _exceptionable) || $report(_exceptionable, {
            path: _path + "",
            expected: "[\"EVENT\", event: Event] | [\"REQ\", subscriptionId: string, ...Partial<{ [event: `#${string}`]: string[]; ids: string[]; authors: string[]; kinds: number[]; since: number; until: number; limit: number; search: string; }>[]] | [\"AUTH\", signedChallengeEvent: Event] | [\"CLOSE\", subscriptionId: string] | [\"COUNT\", subscriptionId: string, ...Partial<{ [event: `#${string}`]: string[]; ids: string[]; authors: string[]; kinds: number[]; since: number; until: number; limit: number; search: string; }>[]]",
            value: input
        })) || $report(true, {
